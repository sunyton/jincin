...
def hack_video(username):
	...
	course_url = 'http://course.njcedu.com/course.svl?lId=1282&time=1445440862714'
	...
	course_headers = {
	                ...
	                'Accept': '*/*',
	                'Referer': 'http://course1.njcedu.com/course.htm?courseId=50&userId=37700006733&schoolId=547&lPanId=0',
	...
	def hack_video(list_id):
	    url_func = 'http://course1.njcedu.com/Servlet/recordStudy.svl'
	    data_func = 'lUserId='+luserid4+'&strStartTime=0&lCourseId='+list_id+'&lSchoolId=547'
	    count = len(data_func)
	    strc = str(count)
	    headers_func = {
