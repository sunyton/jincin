...
course_url = 'http://course.njcedu.com/course.svl?lId=1327&time=1445440862714'
...
course_headers = {
                ...
                'Accept': '*/*',
                'Referer': 'http://course1.njcedu.com/course.htm?courseId=50&userId=37700006733&schoolId=492&lPanId=0',
...
def hack_video(list_id):
    ...
    data_func = 'lUserId='+luserid4+'&strStartTime=0&lCourseId='+list_id+'&lSchoolId=492'
    #print data_func
    #print headers_func
    #print url_func
