...
def hack_video(username):
	...
	course_url = 'http://course.njcedu.com/course.svl?lId=1322&time=1445440862714'
	...
	course_headers = {
	                ...
	                'Accept': '*/*',
	                'Referer': 'http://course1.njcedu.com/course.htm?courseId=50&userId=37700006733&schoolId=192&lPanId=0',
	...
	def hack_video(list_id):
	    ...
	    data_func = 'lUserId='+luserid4+'&strStartTime=0&lCourseId='+list_id+'&lSchoolId=192'
	    #print data_func
	    #print headers_func
	    #print url_func
...
#	print 'All Finished,登陆查看(http://sso.njcedu.com/login.htm)，如果还有未完成的请重新运行'
	return
